(() => {
  ...
  function renderDetail(p){
    ...
    $('.pp-detail-main').insertAdjacentHTML('beforeend', '<section class="pp-panel pp-financing" id="pp-financing" aria-labelledby="pp-financing-title"><span class="pp-eyebrow">Für Kaufinteressenten</span><h2 id="pp-financing-title">Finanzierungsrechner</h2><p>Welche Finanzierung passt zu Ihrem Vorhaben? Sie nutzen den Rechner von Justhome. Ihre Eingaben werden dort verarbeitet. <a href="https://justhome.co/datenschutz" target="_blank" rel="noopener noreferrer">Datenschutz bei Justhome ↗</a></p><div class="pp-financing-widget"><iframe title="Justhome Finanzierungsrechner" src="https://calculator.justhome.com/?partner-id=66f3be08e1c9f54400131a96" width="100%" height="560" loading="eager" referrerpolicy="strict-origin-when-cross-origin" allow="fullscreen"></iframe></div></section>');
