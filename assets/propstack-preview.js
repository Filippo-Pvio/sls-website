(() => {
  ...
  function renderDetail(p){
    ...
    const summary=[fact('Zimmer',p.rooms),fact('Schlafzimmer',p.bedrooms),fact('Badezimmer',p.baths),fact('Wohnfläche',p.area==null?null:area(p.area)),fact('Baujahr',p.year)].join('');
