(() => {
  ...
  function renderDetail(p){
    ...
    const property=(p.objectFacts||[]).map(({label,value,kind})=>fact(label,kind==='currency'?format(value):kind==='area'?area(value):value)).join('');
